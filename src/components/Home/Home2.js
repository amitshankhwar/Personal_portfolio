        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              I fell in love with programming in school and maintained a passion for coding.
              <br />
              ...
              <i>
                ...
                <b className="purple">
                  Automation and Implementing Various Algorithms
                </b>
              </i>
              <br />
              <br />
              Whenever possible, I also apply my passion for developing products
              with <b className="purple"><i>Python</i></b> and
              <i>
                <b className="purple">
                  {" "}
